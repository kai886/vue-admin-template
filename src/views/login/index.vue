<template>
  ...
  <div class="login-container">
    <div class="img-right">
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
        <div>
          <img src="https://wpimg.wallstcn.com/69a1c46c-eb1c-4b46-8bd4-e9e686ef5251.png" style="width:40px;height:40px;transform: translateX(-10px);" alt="">
        </div>
        <div>
          <p style="color:#cccccc">欢迎回来!</p>
        ...
        <div>
          ...
          <el-button :loading="loading" round class="submit" @click.native.prevent="handleLogin">
            <span>登录</span>
          </el-button>
        </div>
    ...
    <div class="img-left">
      <img class="background" src="../../assets/login/background1.png" alt="">
    </div>
